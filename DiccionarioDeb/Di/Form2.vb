...
Public Class Form2
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim leer As New StreamReader("C:\Users\ITQ\source\repos\DiccionarioDeb\Di\list\1.txt")
        ...
        Next item
        Dim im As New StreamReader("C:\Users\ITQ\source\repos\DiccionarioDeb\Di\list\2.txt")
        Dim i As String
        While im.Peek <> -1
        ...
        Dim sig As New StreamReader("C:\Users\ITQ\source\repos\DiccionarioDeb\Di\list\3.txt")
